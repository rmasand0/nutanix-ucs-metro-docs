...
| :--- | :--- | :--- |
| **Primary Site Outage** | **Reachable** | Site B acquires the Witness Lock and is automatically promoted to **Active**. |
| **Primary Site Outage** | **Unreachable** | Site B cannot acquire the lock. It remains in **Standby** to prevent split-brain. |
| **Inter-Site Link (ISL) Failure** | **Both Reachable** | The site that currently holds the "Active" container maintains its lock; the other remains Standby. |
