...
* **[Claim your Certificate of Completion](https://https://github.com/rmasand0/nutanix-ucs-metro-docs/blob/main/docs/CERTIFICATE.md)** *Available to all participants who pass the quiz.*
